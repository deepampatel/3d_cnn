...
def create_model():
    ...
    Conv_3d_1 = Conv3D( filters=4, kernel_size = (6, 6, 6), strides = (1, 1, 1), padding = 'valid', activation = 'relu', use_bias = True)(inp)

    max_pool_1 = MaxPooling3D( pool_size = (2, 2, 2), strides = (1, 1, 1), padding = 'valid')(Conv_3d_1)

    Conv_3d_2 = Conv3D(filters = 4, kernel_size = (4, 4, 4), strides = (1, 1, 1), padding = 'valid', activation = 'relu', use_bias = True)(max_pool_1)

    max_pool_2 = MaxPooling3D( pool_size = (2, 2, 2), strides = (1, 1, 1), padding = 'valid')(Conv_3d_2)
    flatten1 = Flatten()(max_pool_2)
